...
def randomiser():
    ...
    if qnum not in asked:  # Adds the qnum to the asked list to prevent the same question happening twice.
        asked.append(qnum)
    elif qnum in asked:
        randomiser()
...
phy_qanda = {
    1: [
        ...
        'an area of physics concerned with the motion of objects',
        'the interactions between particles',
        'A school of physics which concerns itself with waves',
        2,
        mechanics_score,
        'Mechanics',
        ],
    2: [
        'Who theorised the existence of electrons?',
        'JJ Thompson',
        'John Dalton',
        'Ernest Rutherford',
        'Issac Newton',
        1,
        nuclear_physics_score,
        'Nuclear Physics',
        ],
    3: [
        'What are the two different optics in physics?',
        'Light and Sound',
        'Ray and Wave',
        'Dynamic and Mono',
        'Rays and Orbits',
    ...
    4: [
        ...
        'For every action there is an equal and opposire reaction',
        'The amount of acceleration of a body is proportional to the acting force'
            ,
    ...
    6: [
        ...
        '..The rays cross each other',
        '..The rays seem to cross each other',
        '..The image is above the mirror',
    ...
    8: [
        ...
        'High velocity, but light electrons',
        'Energy from the electromagnetic spectrum',
        'A heavy, slow and positively charged helium nucleus',
        'An ionised particle',
        3,
        nuclear_physics_score,
        'Nuclear Physics',
    ...
    10: [
        '\'For every action there is an \n equal and opposite reaction\' describes...'
            ,
    ...
    12: [
        'Wave optics believes that..',
        '..Light is made out of rays',
        '..Light can be split up from rays into waves',
        '..Light is made up of waves',
        '..Light is formed by waves and rays',
        3,
        waves_score,
        'Waves',
        ],
    13: [
        'What forces effected the projectile in it\'s motion?'
            ,
        'Only Gravity',
        'Gravity and Horozontial force',
        'Gravity and Light',
        'Nothing, it is only directed by the force exerted',
        1,
        mechanics_score,
        'Mechanics',
        ],
    14: [
        ...
        'Half life is a popular video game franchise',
        'The time it takes for the number of undecayed nuclei to fall to half its original number'
            ,
        'The time it takes for decayed nuclei to regenerate',
        'The half point for an organisim',
        2,
        nuclear_physics_score,
        'Nuclear Physics',
        ],
    15: [
        'What is refraction?',
        'The angle when a ray hits a reflective surface',
        'When a light ray goes from one medium to another',
        'The act of light travelling through space in waves',
        'Light creating an image off of a reflective surface',
        2,
        waves_score,
        'Waves',
        ],
...
cs_qanda = {
    1: [
        ...
        'Python is a search engine',
        'Python is a type of snake',
        'Python is a famous car brand',
        1,
        python_score,
        'Python',
        ],
    2: [
        'What does the heuristic, \'Match with the real world\' deal with?'
            ,
        'Make the user able to edit and change their answers',
        'Use familiar icons and concepts found in the real world',
        'Conventions in programming',
        'Able to show the user the status of the system',
        2,
        heuristics_score,
        'Heuristics',
        ],
    3: [
        ...
        'A type of programming technique that is similar to a class',
        'A finite ordered sequence of steps to solve a problem',
        'The observation of sequences within a computer program',
        3,
        algorithms_score,
        'Algorithms',
        ],
    4: [
        'What is the data type for this?: 1.4',
        'Float',
        'Integer',
        'String',
        'Boolean',
    ...
    5: [
        'Who made the design heuristics?',
        'Jakob Nielsen',
        'Jacob Nielsen',
        'John Nelson',
        'Rolf Molich',
    ...
    6: [
        ...
        'Only in Python',
        'Any time to design a solution to a problem',
        'When finding an error',
        'Only when repairing computers',
        2,
        algorithms_score,
        'Algorithms',
        ],
    ...
    10: [
        ...
        'Checks if something is true then executes it',
        'Compares 2 values and returns a true or false',
        'While a statement is true, it will loop a indefinitely until it is not'
            ,
        'A block of code that only runs if called.',
        1,
        python_score,
        'Python',
        ],
    11: [
        'What does the Heuristic \'Diagnose Recover and Errors\' deal with?'
            ,
        'Allows access for more efficient processes',
        'Gives the user the freedom to personalise their experience',
        'After making an error, the user will be able to recover easily'
            ,
        'Follow already existing conventions',
        3,
        heuristics_score,
        'Heuristics',
        ],
    12: [
        'What is the worst case for a search and sort algorithm?',
        'O(n)',
        'O(n/2)',
        'F - (QT)',
        'Y5 - 6',
    ...
    13: [
        '\'Address = []\' is an example of what in python?'
            ,
        'Variable',
        'Integer',
        'Dictionary',
    ...
    14: [
        '\'Clean, Uncluttered, Visible\' is an example of what heuristic?'
            ,
    ...
    15: [
        'What is the best case for a quick sort?',
        'Y4^4',
        'F + (n^6)',
        'n*log(n)',
        'O(f^log(6)',
...
class QuizStarter:  # Class for the UI, the main menu and username
    ...
    def __init__(self, parent):
        ...
        self.user_label = Label(self.quiz_frame, text='Enter your name:'
                                , font=('Tw Cen MT', '14'),
                                bg=background_color,
                                fg=foreground_color)
        ...
        self.continue_button = Button(self.quiz_frame, text='Continue',
                font=('Tw Cen MT', '13', 'bold'), bg='mediumseagreen',
        ...
        self.exit_button = Button(self.quiz_frame, text='Exit',
        ...
        self.error_label = Label(self.quiz_frame, text='',
                                 ...
                                 bg=background_color, fg='indianred')
...
class Selection:  # Class for the quiz selection interface
    ...
    def __init__(self, parent):
     ...
     # Heading for the Quiz Selection
        ...
        self.heading_label = Label(self.quiz_frame,
                                   text='Which Quiz Would you like to do?'
                                   , font=('Tw Cen MT', '17', 'bold'),
                                   bg=background_color,
                                   fg=foreground_color)
     ...
     # Error correction label
        ...
        self.error_show = Label(self.quiz_frame, text='',
                                font=('Tw Cen MT', '10', 'bold'),
                                bg=background_color, fg='indianred')
  ...
  # Start the questions
    ...
    # Loads Computer science questions if the user chooses computer science
          ...
          # If the user does not choose an option, load the error correct label
...
class Quiz:  # Actual quiz
    ...
    # Question label and question number
        ...
        self.question_label = Label(self.quiz_frame, text='1/15) '
                                    + chosen_quiz[qnum][0],
                                    font=('Tw Cen MT', '17', 'bold'),
                                    bg=background_color,
                                    fg=foreground_color)
    ...
    # Error label font, text and colour
        ...
        self.error_label = Label(self.quiz_frame, text='',
                                 font=('Tw Cen MT', '13', 'bold'),
                                 bg=background_color, fg='indian red')
  ...
  # Method that manages the back button of the widget
    ...
    # Brings up a messgae box to confirm the selection
        ...
        msg_box = messagebox.askokcancel(title='Are you sure?',
                message='Are you sure you want to coninue? This will revert you back to the quiz selection'
                )
        if msg_box == True:
  ...
  # Method in charge of the questions setup when the quiz starts
    ...
    # Set the choice back to 0 and configures all widgets for the next question's options and question
        ...
        self.var1.set(0)
        self.question_label.config(text=str(self.change_num) + '/15) '
                                   + chosen_quiz[qnum][0])
        ...
        if chosen_quiz == phy_qanda:  # Manages the scoring for categories in physics
            if chosen_quiz[qnum][7] == 'Mechanics':  # If the category is mechanics, add score towards mechanics_score
                mechanics_score += 1
                                            ...
                                            # If the category is Waves, add score towards waves_score

                waves_score += 1
            else:

            # If the category is nuclear physics, add score towards nuclear_physics_score

                nuclear_physics_score += 1
        else:

          # Manages the categories for computer science

            if chosen_quiz[qnum][7] == 'Python':  # If the category is python, add score towards python_score
                python_score += 1
            elif chosen_quiz[qnum][7] == 'Algorithms':

                                                 # If the category is algorithms, add score towards algorithms_score

                algorithms_score += 1
            else:

            # If the category is heuristics, add score towards heuristics_score
  ...
  # Method in charge of checking if he last question and enacting socre collection
    ...
    # Get the user's choice
        ...
        if len(asked) > 14:  # If it is the final questions
          ...
          # If it isn't the final question
...
class ResultsPage:  # Results page class
    ...
    def __init__(self, parent):
        ...
        self.user_label = Label(self.quiz_frame, text='Results',
                                font=('Tw Cen MT', '20', 'bold'),
                                bg=background_color,
                                fg=foreground_color)
        ...
        self.totalscore_label = Label(self.quiz_frame, text='',
                font=('Tw Cen MT', '15', 'bold'), bg=background_color,
                fg=foreground_color)
        self.totalscore_label.grid(row=6, pady=10, padx=50, column=0)

        self.totalscore = Label(self.quiz_frame, text='',
    ...
    def calculate_results(self):
        ...
        # Compares to the maximum score of 5
            ...
            self.category3_score.config(text=str(nuclear_physics_score)
                    + '/5')

            self.totalscore_label.config(text='Total Score: ')
            self.totalscore.config(text=str(nuclear_physics_score
                                   + waves_score + mechanics_score)
                                   + '/15')  # Adds score together
        else:

            # If the user chose computer science, configure for computer science categories and score
        # Compares to the maximum score of 5
            ...
            self.category2_score.config(text=str(algorithms_score)
                    + '/5')

            self.category3_label.config(text='Heuristics score: ')
            self.category3_score.config(text=str(heuristics_score)
                    + '/5')

            self.totalscore_label.config(text='Total Score: ')
            self.totalscore.config(text=str(python_score
                                   + algorithms_score
                                   + heuristics_score) + '/15')  # Adds scores together
